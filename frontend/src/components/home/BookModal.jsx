    ...
    return (
        ...
        >
            <div onClick={(event) => event.stopPropagation()} className="w-[600px] max-w-full h=[400px] bg-white rounded-xl p-4 flex flex-col relative">
                ...
                <p className="mt-4">"A Deep Dive into <b>{book.title}</b> by <b>{book.author}</b>"</p>
                <p className="my-2">
                "An engaging tale of mystery, intrigue, and unexpected twists that will keep you hooked until the final page."
                </p>
